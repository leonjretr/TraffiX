...
const FooterNavbar = () => {
    return (
        <div className="flex justify-around">
            <Link
                className="flex flex-col items-center text-white text-base mob2:text-lg p-1 mob2:p-0.5 active:bg-main active:ring-1 active:ring-gray-400 focus:ring-1 focus:ring-gray-400 rounded-lg text-regular"
                to={"/top"}>
