...
const WelcomingPage1 = () => {
    ...
    return (
        <motion.div
            className={"WelcomingPage1 bg-black h-screen"}
            initial={{opacity: 0}}
            animate={{opacity: 3}}
            exit={{opacity:0}}
            ...
            <div className={"font-poppinsFont font-semibold text-center pt-16 select-none px-10"}>
                ...
                <h1 className={"text-gray-400 text-xs mt-5"}>Additional things like boosts will be added
                    soon...</h1>
            </div>
            <div className={"flex justify-center mt-8"}>
                <img src={app1} alt={"Screen1"}
                     className={"w-2/5 h-2/5 mob1:w-2/4 mob1:h-2/4 mob2:w-4/6 mob2:h-4/6  rounded-md border-2 border-black shadow-2xl shadow-purple-700"}/>
            </div>
